...
drug_atc = pd.read_csv('data/input/sider/drug_atc.tsv', sep='\t', header=None)
drug_atc.columns = ['stitch', 'atc']
all_se = pd.read_csv('data/input/sider/meddra_all_se.tsv', sep='\t', header=None)
...
side_effects.to_csv('data/output/sider/sider.csv', index=False)